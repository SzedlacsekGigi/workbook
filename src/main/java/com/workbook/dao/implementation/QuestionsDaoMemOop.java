...
public class QuestionsDaoMemOop implements QuestionsDao {
    ...
    private static QuestionsDaoMemOop instance = null;

    private QuestionsDaoMemOop() throws IOException {
        setup("src/main/resources/questions_oop.txt", 1, 79);
        this.getAll();
    }

    public static QuestionsDaoMemOop getInstance() throws IOException {
        if (instance == null) {
            instance = new QuestionsDaoMemOop();
        }
        return instance;
    }
