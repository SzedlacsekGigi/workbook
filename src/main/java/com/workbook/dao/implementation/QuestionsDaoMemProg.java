...
public class QuestionsDaoMemProg implements QuestionsDao {
    ...
    private static QuestionsDaoMemProg instance = null;

    private QuestionsDaoMemProg() throws IOException {
        setup("src/main/resources/questions_progbasics.txt", 1, 59);
        this.getAll();
    }

    public static QuestionsDaoMemProg getInstance() throws IOException {
        if (instance == null) {
            instance = new QuestionsDaoMemProg();
        }
        return instance;
    }
