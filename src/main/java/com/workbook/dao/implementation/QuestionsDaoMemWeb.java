...
public class QuestionsDaoMemWeb implements QuestionsDao {
    ...
    private static QuestionsDaoMemWeb instance = null;

    private QuestionsDaoMemWeb() throws IOException {
        setup("src/main/resources/questions_web_with_python.txt", 1, 96);
        this.getAll();
    }

    public static QuestionsDaoMemWeb getInstance() throws IOException {
        if (instance == null) {
            instance = new QuestionsDaoMemWeb();
        }
        return instance;
    }
